...
const CANONICAL: &[(&[&str], &str, Option<&str>)] = &[
    ...
    (&["sleeping bag", "sleeping bags"], "sleep", Some("sleeping-bag")),
    (&["sleeping pad", "sleeping pads"], "sleep", Some("sleeping-pad")),
    (&["quilt"], "sleep", Some("quilt")),
    (&["backpack", "backpacks", "packs"], "packs", Some("backpack")),
    ...
    (&["water filter", "water purifier", "filtration"], "cooking", Some("water-treatment")),
    ...
    (&["trail running", "trail runners"], "footwear", Some("trail-running")),
    ...
    (&["fitness", "strength", "barbell", "dumbbell"], "fitness", None),
